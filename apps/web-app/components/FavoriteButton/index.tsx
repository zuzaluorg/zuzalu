        ...
        <>
            {userInfo &&
                (isMiniButton ? (
                    ...
                    <button
                        className="flex w-full md:w-auto justify-center gap-2 items-center bg-white border border-primary text-fora-primary font-[600] py-[8px] px-[16px] rounded-[8px]"
                        onClick={() => {
                            if (latestFavoritedSessionId !== null) {
                                handleRemoveFavorite()
                            } else {
