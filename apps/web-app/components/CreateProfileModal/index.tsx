...
const CreateProfileModal = ({ isOpen, closeModal, reRender, setRerender }: Props) => {
    const questionTextRef = useRef(null)
    const [profile, setProfile] = useState({ location: "", company: "", bio: "" })
                                ...
                                <div className="w-full h-full py-5 px-10">
                                    ...
                                    <div className="flex flex-col w-full">
                                        ...
                                        <div className="w-full flex flex-col my-10 items-start">
                                            ...
                                            >
                                                {isLoading ? <Loading size="xs" /> : "CREATE PROFILE"}
                                            </button>
                                        </div>
                                    </div>
                                </div>
