const FullProgramButton = (props: any) => (
    <button
        className="group border-fora-gray800 border font-semibold text-fora-gray900 py-3 px-6 tracking-wide rounded-full"
        {...props}
    >
...
export default FullProgramButton
